...
import { MapPin, Truck, Shield, Sparkles, ArrowRight } from 'lucide-react';
        ...
        <div className="relative">
          ...
          <div className="absolute -top-4 left-8">
            {[...Array(3)].map((_, i) => (
              <div
                key={i}
                className="w-3 h-3 bg-gray-300 rounded-full animate-ping opacity-60"
                style={{
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <div className="flex items-center justify-center mb-4">
            ...
            <span className="text-orange-600 font-semibold text-lg animate-pulse">South Africa's Premier Local Market</span>
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-slate-900 mb-6 animate-fade-in relative">
            <span className="inline-block animate-slide-up">{getHeroText('title').split(' ').slice(0, 2).join(' ')}</span>
            <br />
            <span className="inline-block animate-slide-up delay-300 bg-gradient-to-r from-orange-500 to-orange-600 bg-clip-text text-transparent">
              {getHeroText('title').split(' ').slice(2).join(' ')}
            </span>
          </h1>
